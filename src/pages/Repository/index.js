...
export default class Repository extends Component {
  ...
  render() {
    ...
    if (loading) {
      return <Loading >
        Carregando < /Loading>; } return ( < Container > < Owner > < Link to = "/" > Voltar aos repositórios < /Link> < img src = {repository.owner.avatar_url}
          ...
          < p="p">
            ...
            < /p>
              < /Owner>
                ...
                < IssueList="IssueList">
                  < IssueFilter="IssueFilter" active={filterIndex
}>
                    {
                    ...
                    /li >))
                      ...
                      < /IssueList>
                        < PageActions="PageActions">
                          < button="button" type="button" disabled={page < 2
} onClick {
